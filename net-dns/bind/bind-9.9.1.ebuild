...
# $Header: /var/cvsroot/gentoo-x86/net-dns/bind/bind-9.9.1.ebuild,v 1.1 2012/05/21 23:50:54 idl0r Exp $
...
src_prepare() {
	...
	if use dlz; then
        ...
        # Fix for DLZ compilation issue:
        # https://bugs.gentoo.org/show_bug.cgi?id=406399
        epatch "${FILESDIR}/bind-9.9.0.patch"
	fi
