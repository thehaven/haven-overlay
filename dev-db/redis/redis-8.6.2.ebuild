...
src_install() {
	insinto ${EROOT}/etc/redis
	doins redis.conf sentinel.conf
	use prefix || fowners -R redis:redis ${EROOT}/etc/redis ${EROOT}/etc/redis/{redis,sentinel}.conf
	fperms 0750 ${EROOT}/etc/redis
	fperms 0644 ${EROOT}/etc/redis/{redis,sentinel}.conf
	...
	keepdir ${EROOT}/var/{log,lib}/redis
}
