...
#http://www.percona.com/redir/downloads/Percona-Server-5.6/Percona-Server-5.6.12-rc60.4/source/Percona-Server-5.6.12-rc60.4.tar.gz
SRC_URI="amd64? (
http://www.percona.com/downloads/Percona-Server-${MY_P}/Percona-Server-${MY_PV}/source/Percona-Server-${MY_PV}.tar.gz )
"
