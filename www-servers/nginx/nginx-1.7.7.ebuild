...
NGX_PAGESPEED_MODULE_PV="1.9.32.2-beta"
...
NGX_PAGESPEED_PSOL_PV="1.9.32.2"
...
IUSE="aio debug +http +http-cache ipv6 libatomic luajit +pcre pcre-jit rtmp selinux ssl userland_GNU vim-syntax"
