...
DESCRIPTION="Markdown LSP server with Obsidian-style wikilinks, daily notes, and references"
HOMEPAGE="https://github.com/Feel-ix-343/markdown-oxide"
SRC_URI="https://github.com/Feel-ix-343/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}"
