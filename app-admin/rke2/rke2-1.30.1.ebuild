...
SUFFIX='%2Brke2r1'
# https://github.com/rancher/rke2/releases/download/v1.30.1%2Brke2r1/rke2.linux-amd64.tar.gz
SRC_URI="https://github.com/rancher/rke2/releases/download/v${PV}${SUFFIX}/rke2.linux-amd64.tar.gz -> rke2-v${PV}.linux-amd64.tar.gz"
