...
MY_PN="${PN//-bin}"
DATE="20170712" # http://beta.madsonic.org/pages/changelog.jsp

DESCRIPTION="Madsonic is a complete, personal media streaming solution"
HOMEPAGE="http://www.madsonic.org/"
SRC_URI="http://madsonic.org/download/6.3/${DATE}_madsonic-${PV}-standalone.tar.gz -> madsonic-${PV}-standalone.tar.gz"
