...
MY_PN="${PN//-advanced-bin}"
AIRSONIC_HOME="/var/lib/${MY_PN}"

DESCRIPTION="Airsonic is a personal media server, opensource fork of Subsonic"
HOMEPAGE="https://airsonic.github.io/"
RELEASE="11.0.0-SNAPSHOT"
SRC_URI="https://github.com/airsonic-advanced/airsonic-advanced/releases/download/${RELEASE}.${PV}/airsonic.war -> ${PN}-${RELEASE}.${PV}.war"
...
src_install() {
	newbin "${DISTDIR}/${PN}-${RELEASE}.${PV}.war" "${MY_PN}.war"
