...
SRC_URI="http://haproxy.1wt.eu/download/$(get_version_component_range 1-2)/src/devel/${P}-dev17.tar.gz"
S="/var/tmp/portage/net-proxy/haproxy-1.5-r17/work/haproxy-1.5-dev17"
