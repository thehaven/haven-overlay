...
And may the Force be with you…"
    ...
    ApplyPatch "${FILESDIR}/zram_pagealloc_fix.patch" "Oops: zram_pagealloc_fix
	conflicts found affecting zram allocation: http://code.google.com/p/compcache/issues/detail?id=102"
