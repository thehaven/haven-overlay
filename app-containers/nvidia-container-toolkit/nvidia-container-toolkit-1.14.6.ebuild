...
if [[ "${PV}" == "9999" ]] ; then
	...
	SRC_URI="
		...
		https://github.com/thehaven/gentoo-go-deps/releases/download/${P}/${P}-deps.tar.xz
		https://github.com/thehaven/gentoo-go-deps/releases/download/${P}/${P}-vendor.tar.xz
	"
