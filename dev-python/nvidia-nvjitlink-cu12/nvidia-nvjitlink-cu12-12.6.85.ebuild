...
WHEEL_URL="https://files.pythonhosted.org/packages/9d/d7/c5383e47c7e9bf1c99d5bd2a8c935af2b6d705ad831a7ec5c97db4d82f4f/nvidia_nvjitlink_cu12-${PV}-py3-none-manylinux2010_x86_64.manylinux_2_12_x86_64.whl"
...
python_install() {
	...
	insinto "${sitedir}"
	doins -r "${WORKDIR}/nvidia_nvjitlink_cu12-12.6.85.dist-info"
}
