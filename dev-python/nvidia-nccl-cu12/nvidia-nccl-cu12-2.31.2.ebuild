...
WHEEL_URL="https://files.pythonhosted.org/packages/0f/36/104de52d6368f5b7f886e8fd252e0a438fe73a215e59b1b47f93a80ae2ea/nvidia_nccl_cu12-2.31.2-py3-none-manylinux_2_18_x86_64.whl"
...
python_install() {
	...
	insinto "${sitedir}"
	doins -r "${WORKDIR}/nvidia_nccl_cu12-2.31.2.dist-info"
}
