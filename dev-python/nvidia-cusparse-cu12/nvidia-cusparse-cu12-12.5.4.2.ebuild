...
WHEEL_URL="https://files.pythonhosted.org/packages/06/1e/b8b7c2f4099a37b96af5c9bb158632ea9e5d9d27d7391d7eb8fc45236674/nvidia_cusparse_cu12-${PV}-py3-none-manylinux2014_x86_64.manylinux_2_17_x86_64.whl"
...
python_install() {
	...
	insinto "${sitedir}"
	doins -r "${WORKDIR}/nvidia_cusparse_cu12-12.5.4.2.dist-info"
}
