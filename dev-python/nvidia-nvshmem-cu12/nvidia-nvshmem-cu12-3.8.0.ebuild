...
WHEEL_URL="https://files.pythonhosted.org/packages/42/1d/3ffe6972761c9e77d6bf3cc15d0cea27ac23341de5436e091c6c965c3886/nvidia_nvshmem_cu12-3.8.0-py3-none-manylinux2014_x86_64.manylinux_2_17_x86_64.whl"
...
python_install() {
	...
	insinto "${sitedir}"
	doins -r "${WORKDIR}/nvidia_nvshmem_cu12-3.8.0.dist-info"
}
