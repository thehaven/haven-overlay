...
WHEEL_URL="https://files.pythonhosted.org/packages/75/2e/46030320b5a80661e88039f59060d1790298b4718944a65a7f2aeda3d9e9/nvidia_cuda_nvrtc_cu12-${PV}-py3-none-manylinux2014_x86_64.whl"
...
python_install() {
	...
	insinto "${sitedir}"
	doins -r "${WORKDIR}/nvidia_cuda_nvrtc_cu12-12.6.77.dist-info"
}
