...
IUSE="+nodejs +ruff +shfmt +uv clang deno elixir gleam go +lsp +mcp +plugins rust terraform zig"
...
BDEPEND="|| ( >=dev-lang/bun-bin-1.3.14 >=dev-lang/bun-1.3.14 )"
RDEPEND="
	dev-vcs/git
	...
	mcp?       ( dev-util/mcp-meta )
	plugins?   ( dev-util/opencode-plugins )
	uv?        ( dev-python/uv )
	zig?       ( dev-lang/zig )
