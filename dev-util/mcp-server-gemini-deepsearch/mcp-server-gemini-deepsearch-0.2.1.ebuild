...
pkg_postinst() {
	...
	elog "    "gemini-deepsearch": {"
	elog "      "type": "local","
	elog "      "command": ["/usr/bin/gemini-deepsearch-mcp"],"
	elog "      "environment": {"
	elog "        "GEMINI_API_KEY": "{env:GEMINI_API_KEY}","
	elog "        "QUERY_GENERATOR_MODEL": "gemini-3.1-flash","
	elog "        "WEB_SEARCH_MODEL": "gemini-3.1-flash","
	elog "        "REFLECTION_MODEL": "gemini-3.1-flash","
	elog "        "ANSWER_MODEL": "gemini-3.1-pro","
	elog "        "REASONING_MODEL_LOW": "gemini-3.1-flash","
	elog "        "REASONING_MODEL_MEDIUM": "gemini-3.1-flash","
	elog "        "REASONING_MODEL_HIGH": "gemini-3.1-pro","
	elog "        "QUERY_COUNT_LOW": "1","
	elog "        "QUERY_COUNT_MEDIUM": "3","
	elog "        "QUERY_COUNT_HIGH": "5","
	elog "        "LOOP_COUNT_LOW": "1","
	elog "        "LOOP_COUNT_MEDIUM": "2","
	elog "        "LOOP_COUNT_HIGH": "3","
	elog "        "DEFAULT_EFFORT": "medium""
	elog "      },"
	elog "      "enabled": true"
	elog "    }"
}
